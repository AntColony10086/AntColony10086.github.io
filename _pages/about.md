...
> **Building multimodal agent systems for real-world visual tasks.**
> Perception models handle grounding; agents orchestrate tools, active learning, evaluation, and human-in-the-loop collaboration.
>
> *面向真实视觉任务的多模态 Agent 系统：感知模型负责 grounding，Agent 负责工具编排、主动学习、评测与人机协同。*

---

I am an undergraduate student in **Electronic Engineering at Xinjiang University** (GPA 4.10/5.00, ranked **4 / 73**, top 5.48%).

My work sits at the intersection of three threads:

- **Multimodal perception** — YOLO-family detection, DeepLabv3 segmentation, few-shot/long-tail visual recognition.
